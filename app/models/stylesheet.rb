class Stylesheet < ActiveRecord::Base
  ...
  def self.css
    ".bg-red { background-color: #{Stylesheet.primary}; }
     ...
     a.fa-long-arrow-left-class > i { color: black; }
     a.fa-long-arrow-left-class:hover > i { color: white; }
     ...
     .block-link:hover, .fc-toolbar .fc-button:hover, .fc-toolbar .fc-button:active, .fc-toolbar .fc-button.fc-state-active { background-color: #{Stylesheet.secondary}; color: white; }
     ...
     .btn-warning, .editable-buttons button[type=submit].btn-primary { background-color: #{Stylesheet.secondary} !important; border-color: #{Stylesheet.secondary} !important; color: white !important; }
     ...
     .btn-warning-full { border-color: #{Stylesheet.secondary}; background-color: #{Stylesheet.secondary}; color: white !important; }
     .btn-warning-full:hover {color: black !important; }
